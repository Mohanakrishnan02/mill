...
export function HeroSection() {
  return (
    <section className="relative min-h-[520px] overflow-hidden bg-[#5C1F28] text-white lg:min-h-[580px]">
      ...
      <Image
        ...
        aria-hidden
      />
      <div className="absolute inset-0 bg-gradient-to-r from-[#2A1418]/95 via-[#2A1418]/75 to-[#2A1418]/40" />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:py-20">
        ...
        <div className="hero-stagger">
          <p className="hero-item inline-flex rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs uppercase tracking-widest text-[#F5A962] backdrop-blur-sm">
          ...
          >
            ஜெயலட்சுமி விலாஸ்
            <br />
            <em className="not-italic text-[#F5A962]">Rice Mill, Melur</em>
          </h1>
          <p
            className="hero-item mt-2 text-sm text-[#F5A962]/80"
          ...
          <div className="hero-item mt-8 flex flex-wrap gap-3">
            <Link
              href="/products"
              className="btn-shimmer rounded bg-[#E07A2F] px-6 py-3 text-sm font-bold shadow-lg shadow-[#E07A2F]/30 transition hover:scale-[1.03] hover:bg-[#F5A962]"
            >
              🛒 Shop Rice Varieties
            </Link>
            <a
          ...
          <div className="hero-item mt-10 grid grid-cols-2 gap-6 sm:flex sm:flex-wrap sm:gap-8">
            {[
              ...
              <div key={s.l} className="stat-pop">
                <p
                  className="text-2xl font-bold text-[#F5A962]"
                  style={{ fontFamily: "var(--font-yeseva)" }}
                >
                  {s.n}
                </p>
        ...
        <div className="hero-item relative mx-auto w-full max-w-xl lg:max-w-2xl">
          ...
          <div className="annapurna-frame relative overflow-hidden rounded-2xl border-2 border-[#F5A962]/50 shadow-2xl shadow-[#F5A962]/25 animate-float">
            <div className="relative aspect-[1000/666] w-full overflow-hidden bg-[#2A1418]">
              <Image
            ...
            <div className="border-t border-[#F5A962]/30 bg-gradient-to-r from-[#2A1418] via-[#2A1418] to-[#2A1418] px-4 py-3 text-center">
              <p
                className="text-base font-bold text-[#F5A962] sm:text-lg"
                style={{ fontFamily: "var(--font-yeseva)" }}
              >
