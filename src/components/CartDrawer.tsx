  ...
  return (
    <>
      ...
      <aside className="fixed right-0 top-0 z-50 flex h-full w-full max-w-md flex-col bg-white shadow-2xl">
        <div className="flex items-center justify-between bg-[#2F6B3A] px-4 py-3.5 text-white">
          <div>
        ...
        {!isHydrated ? (
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-4 px-6 text-center">
            ...
            <Link href="/products" onClick={closeDrawer} className="rounded bg-[#D4A017] px-6 py-2.5 text-sm font-bold text-[#14261C]">
              Shop Rice Varieties
            </Link>
          </div>
        ) : (
          <>
            ...
            <div className="border-t bg-[#FAF6EB] p-4">
              ...
              <Link
                href="/checkout"
                onClick={closeDrawer}
                className="mt-3 block w-full rounded bg-[#D4A017] py-3 text-center text-sm font-extrabold text-[#14261C] hover:bg-[#E8C547]"
              >
                PROCEED TO CHECKOUT →
              </Link>
            </div>
