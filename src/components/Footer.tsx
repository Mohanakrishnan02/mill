...
export function Footer() {
  return (
    <footer id="contact" className="mt-auto scroll-mt-24 bg-[#1a0f05] text-stone-400">
      ...
      <div className="footer-banner-wrap relative w-full overflow-hidden border-b border-white/5 bg-[#2a2018]">
        ...
        <div className="footer-banner-glow pointer-events-none absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#f5a623]/50 to-transparent" />
      </div>
          ...
          <div className="mt-3 rounded-xl border border-white/10 bg-white/5 p-4">
            ...
            <div className="mt-3 flex flex-wrap gap-1.5">
              {[
                ...
                <span
                  key={tag}
                  className="rounded-full border border-[#f5a623]/25 bg-[#f5a623]/10 px-2.5 py-0.5 text-[10px] font-semibold text-[#f5a623]"
                >
                  {tag}
                </span>
              ))}
            ...
            <ul className="mt-3 space-y-2 border-t border-white/10 pt-3 text-xs">
              <li className="flex items-center gap-2 text-stone-400">
                <Clock className="h-3.5 w-3.5 shrink-0 text-[#f5a623]" />
                {MILL.hours}
              </li>
              <li className="flex items-center gap-2 text-stone-400">
                <ShieldCheck className="h-3.5 w-3.5 shrink-0 text-[#2e7d32]" />
